...
<h1> Blog site advanced Full course without using any editor</h1> 
</p>
...
<li>Search and sort to easily find posts by specific variables</li>
<li>Dynamic Breadcrumbs</li>
<li>Post Availability Filters</li>
<li>Post WishList</li>
<li>Multi Category</li>
<li>Multi Tag</li>
<li>Email Verify</li>
<li>Multiple Images Post</li>
<li>Filter View</li>
...
<h2 dir="auto"><a id="user-content-table-of-contents" class="anchor" aria-hidden="true" href="#table-of-contents"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="m7.775 3.275 1.25-1.25a3.5 3.5 0 1 1 4.95 4.95l-2.5 2.5a3.5 3.5 0 0 1-4.95 0 .751.751 0 0 1 .018-1.042.751.751 0 0 1 1.042-.018 1.998 1.998 0 0 0 2.83 0l2.5-2.5a2.002 2.002 0 0 0-2.83-2.83l-1.25 1.25a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042Zm-4.69 9.64a1.998 1.998 0 0 0 2.83 0l1.25-1.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042l-1.25 1.25a3.5 3.5 0 1 1-4.95-4.95l2.5-2.5a3.5 3.5 0 0 1 4.95 0 .751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018 1.998 1.998 0 0 0-2.83 0l-2.5 2.5a1.998 1.998 0 0 0 0 2.83Z"></path></svg></a>Posts Filter Page</h2>
<ul dir="auto">
<li>Category,Tag,Status filtering process</li> 
<li>Multi Select Category and Tag tracking</li>
<li>Histrory : Return to page previous state when pressing back button on post filter page</li>
...
<ul dir="auto">
<li>Shortcut Actice Posts,InActice Posts,Template Posts,Category,Tag,Users</li>
